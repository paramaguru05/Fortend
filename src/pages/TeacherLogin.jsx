...
import {staffLogin,forgetPassword} from "./../services/staff/staff"
...
const TeacherLogin = () => {
  ...
  const handleChangePassword = async () =>{
    ...
    if(success){
      ...
      let response = await forgetPassword(input.dptName.value,{email:input.email})
      ...
      // try {
      //   let response = await axios.post(`http://localhost:3501/api/v1/${input.dptName.value}/staff/forgetPassword`,{email:input.email})
      //   
      // } catch (error) {
      //   console.log( error )
      // }
